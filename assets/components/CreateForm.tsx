...
const CreateForm = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const response = await axios.post("http://192.168.1.5:5000/register", {
  ...
  return (
    <View style={LoginStyles.container}>
      {/* Banner di stato registrazione */}
      {registerStatus && (
        <View style={[LoginStyles.banner, registerStatus.type === 'success' ? LoginStyles.successBanner : LoginStyles.errorBanner]}>
      ...
      <Button title="Registrati" onPress={handleSubmit} />
